-- Supabase Migration Script (Clean Version)
-- Run these commands in your Supabase SQL Editor
-- This version removes all commands that require superuser privileges
...
-- Create RLS policies for authenticated users (drop existing ones first to avoid conflicts)
...
-- RLS policies for manual overrides - users can view all but only supervisors can create
...
-- RLS policies for daily induction runs - accessible to all authenticated users
